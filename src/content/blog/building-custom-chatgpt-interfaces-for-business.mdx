...
data: "Data + Tool Access Layer" {
  rag: "Knowledge Base Retrieval\nRAG over docs and support content" {
    shape: rectangle
  }
  external: "External Business Systems\nCRM, databases, billing, inventory" {
    shape: rectangle
  }
}
...
response: "Response Generation\nGrounded answer and next action" {
  shape: rectangle
}

app.orchestration -> data.rag
app.orchestration -> data.external
data.rag -> llm
data.external -> llm
llm -> response
```
